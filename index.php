...
<head>
	...
	<title>SIMPENDES</title>
	<link rel="icon" href="dist/img/mabar.png">
...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		<!-- Navbar -->
		<nav class="main-header navbar navbar-expand navbar-red navbar-light" style="background-color: teal">
			<!-- Left navbar links -->
			<ul class="navbar-nav">
				<li class="nav-item">
			...
			<ul class="navbar-nav ml-auto">
				<li class="nav-item d-none d-sm-inline-block">
					<a href="index.php" class="nav-link">
						<font color="white">
						<marquee behavior="scroll" direction="left" style="font-size: 24px; font-weight: bold;">
        SISTEM INFORMASI DATA KEPENDUDUKAN DESA COAL
    </marquee>
						</font>
					</a>
				</li>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: teal">
			...
			<a href="index.php" class="brand-link">
				<img src="dist/img/mabar.png" alt="AdminLTE Logo" class="brand-image" style="opacity: .9">
				<span class="brand-text"> DESA COAL</span>
			</a>
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-2 pb-2 mb-2 d-flex">
					...
					?>
					<div class="image">
						<img src="dist/img/etus.jpg" alt="AdminLTE Logo" class="brand-image">
					</div>
					...
					?>
					<div class="image">
						<img src="dist/img/batik.jpg" alt="AdminLTE Logo" class="brand-image">
					</div>
					<?php 
					}
					?>
        ...
        ?>
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="?page=data-lahir"class="nav-link text-blue">
										<i class="nav-icon fas fa-users"></i>
										<p>Data Lahir</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=data-mendu"class="nav-link text-blue">
										<i class="av-icon fas  fa-ambulance"></i>
										<p>Data Meninggal</p>
									</a>
								</li>

								<li class="nav-item">
									<a href="?page=data-datang"class="nav-link text-blue">
										<i class="nav-icon fas fa-plus"></i>
										<p>Data Pendatang</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=data-pindah" class="nav-link text-blu">
								...
								<li class="nav-item">
									<a href="?page=data-bantuan" class="nav-link text-blu">
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="?page=cetak-penduduk" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Data Penduduk</p>
									</a>
								</li>
								...
								<li class="nav-item">
									<a href="?page=cetak-lahir" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Data Lahir</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=cetak-mati" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Data Meninggal</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=cetak-datang" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Data Pendatang</p>
									</a>
								</li>
								...
								<li class="nav-item">
									<a href="?page=cetak-bantuan" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Data Bantuan</p>
									</a>
								</li>
		  ...
		  -->
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="?page=cetak-pindah" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Data Pindah</p>
									</a>
								</li>
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
				...
				case 'cetak-pindah':
					...
					break;
				case 'cetak-bantuan':
					include "report/cetak_bantuan.php";
					break;
              ...
              //default/false
             default:
                  echo "<center><b>Belum jadi</b></center>";
                  break;    
          }
      }else{
