	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="nm_ayah_pdd" name="nm_ayah_pdd" placeholder="Nama Ayah" required>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="nm_ibu_pdd" name="nm_ibu_pdd" placeholder="Nama Ibu" required>
				</div>
			</div>
...
<?php
$server = "localhost"; // Sesuaikan dengan konfigurasi server Anda
$username = "root"; // Username MySQL
$password = ""; // Password MySQL (kosongkan jika tidak ada)
$database = "db_sippendess"; // Nama database yang digunakan

// Membuat koneksi
$koneksi = new mysqli($server, $username, $password, $database); // Perbaiki penggunaan variabel $database
...
if (isset($_POST['Simpan'])){
    ...
    $sql_simpan = "INSERT INTO tb_pdd (nik, nama, tempat_lh, tgl_lh, jekel, desa, rt, rw, agama, kawin, pekerjaan, nm_ayah_pdd, nm_ibu_pdd, status) VALUES (
        '".$_POST['nik']."',
        '".$_POST['nama']."',
        '".$_POST['tempat_lh']."',
        '".$_POST['tgl_lh']."',
    ...
    $query_simpan = mysqli_query($koneksi, $sql_simpan); // Tidak perlu perubahan disini
