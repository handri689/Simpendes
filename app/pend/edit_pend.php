	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="nm_ayah_pdd" name="nm_ayah_pdd" value="<?php echo $data_cek['nm_ayah_pdd']; ?>"
					/>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="nm_ibu_pdd" name="nm_ibu_pdd" value="<?php echo $data_cek['nm_ibu_pdd']; ?>"
					/>
				</div>
			</div>
		...
		<div class="card-footer">
			...
			<a href="?page=data_penduduk" title="Kembali" class="btn btn-secondary">Batal</a>
		</div>
	</form>
</div>
...
<?php
    ...
    $sql_ubah = "UPDATE tb_pdd SET 
		...
		nm_ayah_pdd='".$_POST['nm_ayah_pdd']."',
		nm_ibu_pdd='".$_POST['nm_ibu_pdd']."'
    ...
    if ($query_ubah) {
      ...
      Swal.fire({title: 'Ubah Data Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
        ...
        {window.location = 'index.php?page=data_penduduk';
        }
      })</script>";
      }else{
      echo "<script>
