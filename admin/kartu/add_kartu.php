	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="nm_ayah" name="nm_ayah" placeholder="Nama Ayah" required>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="nm_ibu" name="nm_ibu" placeholder="Nama Ibu" required>
				</div>
			</div>
...
<?php
    ...
    //mulai proses simpan data
        $sql_simpan = "INSERT INTO tb_kk (no_kk, kepala, nm_ayah,nm_ibu, desa, rt, rw, kec, kab, prov) VALUES (
            '".$_POST['no_kk']."',
            '".$_POST['kepala']."',
			'".$_POST['nm_ayah']."',
			'".$_POST['nm_ibu']."',
