   ...
   <div style="background: red">
	 <div style="text-align: center;">
  		<b style="font-size: 30px; font-family:'Times New Roman', Times, serif; color: white">
			" Hallo, Selamat Datang Administrator " 
		</b>
		<p style="font-family: Times New Roman; font-size: 17px; color: white">
  			Sebuah sistem Pengelolaan Data Desa Coal yang mempermudah dalam pendataan penduduk dengan praktis, cepat, dan akurat.  
		</p>
